    ...
    <v-row class="pa-5 justify-center d-flex align-center">
        <v-card width="500px" height="350px" class="pa-10">
            <v-row class="w-100 justify-center d-flex align-center">
                <v-row class="w-100 justify-center d-flex align-center">
                    <span>Login as</span>
                    <span class="ml-1 text-decoration-underline" @click="goToWriterLogin()">Writer</span>
                </v-row>
                <v-row class="w-100 justify-center d-flex align-center">
                    <v-col cols="12">
...
function goToWriterLogin() {
    router.push("/login/writer");
}
...
function login() {
    ...
    if (username.value && password.value) {
        ...
        router.push('/editor'); // Example of redirecting to another page after login
